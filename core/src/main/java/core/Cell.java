...
public class Cell<T extends Agent> implements Positionable {
    ...
    /**
     *  list of core.agents that this cell contains
     */
    ...
    /**
     * remove agent from the core.agents lisst
    ...
    /**
     * @return iterator over the core.agents that this cell contains
     */
    public Iterator<T> getAgents() {
        return agents.iterator();
    }

    /** @return number of core.agents contained in the cell */
