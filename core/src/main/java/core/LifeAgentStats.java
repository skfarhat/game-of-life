...
public class LifeAgentStats extends Observable {
    ...
    /** total number of core.agents of agentType that have been created - counter increments in LifeAgent constructors */
    private long nbCreated = 0;

    /** total number of core.agents of agentType that have died - counter increments in die() method */
    private long nbDied = 0;

    /** total number of core.agents of agentType that have reproduced - counter increments in reproduce() method */
