...
public class LifeAgentTest {
    ...
    /** @return a subclass of LifeAgent with position (Point2D) passed - reproduce method is not implemented  */
    ...
    /** @return a subclass of LifeAgent with position and energy passed - reproduce method is not implemented  */
